...
Instead of calling +has_many :them, :through => :joiner+ you now call
+has_many_extended :them, :through => :joiner+. It wraps the has_many
...
has_many also fit onto has_many_extended. *Be aware* that
...
want to create
  ...
  *attributes:*:: Specify a list of attributes to create on this end of
                  the relationship.
